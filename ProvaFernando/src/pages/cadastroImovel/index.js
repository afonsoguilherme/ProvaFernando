    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.form}>
          <View style={styles.form}>
            <Icon name="font" size={18} style={styles.inlineImg} />
            <TextInput
              style={styles.input}
          ...
          <View style={styles.form}>
            <Icon name="crosshairs" size={18} style={styles.inlineImg} />
            <TextInput
              style={styles.input}
          ...
          <View style={styles.form}>
            <Icon name="compass" size={18} style={styles.inlineImg} />
            <TextInput
              style={styles.input}
              placeholder="Cidade de imóvel"
              autoCapitalize="none"
              autoCorrect={false}
              value={cidade}
          ...
          <View style={styles.form}>
            <Icon name="globe" size={18} style={styles.inlineImg} />
            <TextInput
              style={styles.input}
          ...
          <View style={styles.form}>
            <Icon name="comment" size={18} style={styles.inlineImg} />
            <TextInput
              style={styles.input}
